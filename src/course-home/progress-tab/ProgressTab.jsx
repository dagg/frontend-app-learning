...
const ProgressTab = () => {
  ...
  // DAGG ADDITIONS START 1 //
  // console.log('>>>>>>' + JSON.stringify(useModel('progress', courseId)));
  ...
  // console.log('ENABLE CERT 2: ' + enablecert);
  // console.log('SHOW PROGRESS (Grades and Grade Summary): ' + showprogress);
